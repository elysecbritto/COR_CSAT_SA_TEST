$key="bf7cdd8270ce4ed98e0ffe6887dc23b2"
$endpoint="https://cor-csat-sa-test.cognitiveservices.azure.com/"
...
$url = "https://raw.githubusercontent.com/elysecbritto/COR_CSAT_SA_TEST/main/$txt_file"
